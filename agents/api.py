"""
FastAPI REST API Server for Intraclass Correlation Icc Calc.
"""
...
app = FastAPI(
    title="Intraclass Correlation Icc Calc API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "intraclass-correlation-icc-calc", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
